...
import stquokka.codeStudy.common.exception.User.PasswordNotMatchException;
import stquokka.codeStudy.common.exception.token.TokenSaveFailedException;
import stquokka.codeStudy.common.util.JwtParser;
...
import stquokka.codeStudy.domain.user.common.CustomUserDetails;
...
import stquokka.codeStudy.common.exception.security.*;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse refresh(TokenRefreshRequest request) {
        ...
        // 2. 리프레시 토큰 유효성 검증
        DecodedJwtToken decodedJwtToken = jwtProcessor.decodeToken(request.refreshToken(), JwtConstants.REFRESH_TOKEN);
